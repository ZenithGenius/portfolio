...
function loadBaseMover(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addMover("base", () => new BaseMover(), refresh);
  });
}
...
function loadCircleShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape("circle", new CircleDrawer(), refresh);
  });
}
...
function loadColorUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("color", (container) => new ColorUpdater(container), refresh);
  });
}
...
function loadOpacityUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("opacity", (container) => new OpacityUpdater(container), refresh);
  });
}
...
function loadOutModesUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("outModes", (container) => new OutOfCanvasUpdater(container), refresh);
  });
}
...
function loadSizeUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("size", () => new SizeUpdater(), refresh);
  });
}
...
function loadExternalAttractInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalAttract", (container) => new Attractor(engine, container), refresh);
  });
}
...
function loadExternalBounceInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalBounce", (container) => new Bouncer(container), refresh);
  });
}
...
var Bubbler = class extends ExternalInteractorBase {
  ...
  isEnabled(particle) {
    const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = (particle?.interactivity ?? options.interactivity).events, {
      ...
      onDiv,
      onHover
    } = events, divBubble = isDivModeEnabled("bubble", onDiv);
...
function loadExternalBubbleInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalBubble", (container) => new Bubbler(container), refresh);
  });
}
...
function loadExternalConnectInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalConnect", (container) => new Connector(container), refresh);
  });
}
...
function loadExternalGrabInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalGrab", (container) => new Grabber(container), refresh);
  });
}
...
function loadExternalPauseInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalPause", (container) => new Pauser(container), refresh);
  });
}
...
function loadExternalPushInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalPush", (container) => new Pusher(container), refresh);
  });
}
...
function loadExternalRemoveInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalRemove", (container) => new Remover(container), refresh);
  });
}
      ...
      if (repulse.clicking) {
        ...
        for (const particle of query) {
          const {
            ...
            dy,
            distance
          } = getDistances(mouseClickPos, particle.position), d = distance ** 2, velocity = repulseOptions.speed, force = -repulseRadius * velocity / d;
          if (d <= repulseRadius) {
...
function loadExternalRepulseInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalRepulse", (container) => new Repulser(engine, container), refresh);
  });
}
...
function loadExternalSlowInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalSlow", (container) => new Slower(container), refresh);
  });
}
...
function replaceImageColor(image, imageData, color, particle) {
  ...
  return new Promise((resolve) => {
    ...
    img.addEventListener("error", () => __async(this, null, function* () {
      domUrl.revokeObjectURL(url);
...
function loadLifeUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("life", (container) => new LifeUpdater(container), refresh);
  });
}
...
function loadLineShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape("line", new LineDrawer(), refresh);
  });
}
...
function loadParallaxMover(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addMover("parallax", () => new ParallaxMover(), refresh);
  });
}
    ...
    return __async(this, null, function* () {
      ...
      for (const p2 of query) {
        ...
        const pos2 = p2.getPosition(), {
          dx,
          dy
        } = getDistances(pos1, pos2), rotate = p1.options.move.attract.rotate, ax = dx / (rotate.x * 1e3), ay = dy / (rotate.y * 1e3), p1Factor = p2.size.value / p1.size.value, p2Factor = 1 / p1Factor;
...
function loadParticlesAttractInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("particlesAttract", (container) => new Attractor2(container), refresh);
  });
}
...
function loadParticlesCollisionsInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("particlesCollisions", (container) => new Collider(container), refresh);
  });
}
...
function loadLinksInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("particlesLinks", (container) => new Linker(container), refresh);
  });
}
  ...
  constructor(container) {
    ...
    this._drawLinkLine = (p1, link) => {
      ...
      container2.canvas.draw((ctx) => {
        ...
        const width = p1.retina.linksWidth ?? 0, maxDistance = p1.retina.linksDistance ?? 0, {
          backgroundMask
        } = options;
        drawLinkLine({
          context: ctx,
...
function loadGenericPolygonShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape("polygon", new PolygonDrawer(), refresh);
  });
}
function loadTriangleShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape("triangle", new TriangleDrawer(), refresh);
  });
}
...
function loadRotateUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("rotate", (container) => new RotateUpdater(container), refresh);
  });
}
...
function loadSquareShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape(["edge", "square"], new SquareDrawer(), refresh);
  });
}
...
function loadStarShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape("star", new StarDrawer(), refresh);
  });
}
...
function loadStrokeColorUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("strokeColor", (container) => new StrokeColorUpdater(container), refresh);
  });
}
...
function loadTextShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape(validTypes, new TextDrawer(), refresh);
  });
}
...
function loadSlim(engine, refresh = true) {
  return __async(this, null, function* () {
    ...
    yield loadTextShape(engine, false);
